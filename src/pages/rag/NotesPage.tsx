...
export function NotesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Generate Lecture Notes</h1>
        ...
        <div className="lg:col-span-2">
          {result ? (
            ...
            <div className="flex h-full min-h-64 flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-gray-200 p-16 text-center">
              ...
              <div>
                <p className="font-semibold text-gray-500">No notes generated yet</p>
                <p className="mt-1 text-sm text-gray-400">Select a book and chapter, then generate.</p>
              </div>
            </div>
          )}
        </div>
