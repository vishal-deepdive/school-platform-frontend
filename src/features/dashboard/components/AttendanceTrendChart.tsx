          ...
          <ResponsiveContainer width="100%" height="100%">
            {mode === "percentage" ? (
              ...
              >
                ...
                />
                <Bar dataKey="present" name="Present" stackId="day" fill={STATUS_META.P.color} maxBarSize={26} animationDuration={250} animationEasing="ease-out" />
                <Bar dataKey="late" name="Late" stackId="day" fill={STATUS_META.L.color} maxBarSize={26} animationDuration={250} animationEasing="ease-out" />
                <Bar dataKey="half_day" name="Half day" stackId="day" fill={STATUS_META.H.color} maxBarSize={26} animationDuration={250} animationEasing="ease-out" />
                <Bar dataKey="excused" name="Excused" stackId="day" fill={STATUS_META.E.color} maxBarSize={26} animationDuration={250} animationEasing="ease-out" />
                <Bar
                  dataKey="absent"
                  name="Absent"
                  stackId="day"
