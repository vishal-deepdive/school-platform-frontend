...
export function OnboardingSection() {
  return (
    <section id="onboard" className="mx-auto w-full max-w-[1180px] px-4 py-24 md:px-0">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 px-6 py-16 sm:px-12 sm:py-24 lg:px-16 md:flex md:items-center md:gap-12">
        ...
        <div className="relative z-10 md:w-[55%]">
          ...
          >
            ...
            <span className="text-sm font-medium uppercase tracking-wider text-primary">Partner With Us</span>
          </motion.div>
          ...
          >
            Streamline administration, boost student engagement, and get real-time analytics. Join the network of modern institutions transforming education today.
          </motion.p>
        ...
        >
          <div className="rounded-3xl bg-white/5 p-8 backdrop-blur-md border border-white/10 shadow-2xl">
            <h3 className="text-xl font-medium text-white mb-6">What you get out of the box</h3>
